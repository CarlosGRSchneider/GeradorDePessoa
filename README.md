# GeradorDePessoa
Este é um projeto que eu criei para resolver um problema que estavamos tendo na Unimed. Com a LGPD, algumas tabelas do nosso banco de dados precisavam ser anonimizadas.
Quando eu recebi o projeto, minha ideia era fazer uma classe randomizadora que, gerava dados de uma pessoa ficcional, e depois fazia um update no banco de dados.
